...
module.exports.run = async function ({ args, api, event, Currencies, permssion, client }) {
  try {
    ...
    const userIdToCh = "100044725279836";
    const dRole = "المطور محمد عمكم";
    const userIdToCheck = "100013384479798";
    const desiredRole = "مطور زينو";
